...
Endpoint: *nil*  
<span style="color:green;">&#10004;</span> All Student-Courses retrieved successfully. 
...
### Update Student-Course by ID [PATCH]  
Endpoint: *:id* 
<span style="color:red;">&#10060;</span>  Endpoint not implemented



### Delete Student-Course [DELETE]  
Endpoint: *:id*  
<span style="color:red;">&#10060;</span> Action not possible

``` Error Response
"message": "update or delete on table \"student_course\" violates foreign key constraint \"FK_c86b8c6ee305b2b82a94789dc69\" on table \"result\""
```
